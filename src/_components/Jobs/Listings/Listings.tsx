...
import { ButtonGroup } from '@/_components/Jobs/ButtonGroup/ButtonGroup';
                ...
                <section className={styles.title_wrap}>
                  ...
                  {hasPublicAccess ?
                    <div className={styles.listings_btnGroup}>
                      ...
                      <button onClick={() => setLikeAndWriteToLocalStorage(_id)}><Heart
                        className={clsx(isLiked && styles.heart)} /></button>
                    </div>
                    :
